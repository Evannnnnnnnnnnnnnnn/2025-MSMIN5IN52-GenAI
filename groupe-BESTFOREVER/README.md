...
Tu indiques dans un texte fluide (il faut demander à l'utilisateur s'il ne donne pas tout):

- La **destination** (ex: Tokyo 🇯🇵)
- Les **dates de voyage**
- Le **budget** et préférences
...
Jour 3 : Excursion au Mont Fuji (quand météo favorable)
Jour 4 : ...
Jour X : Retour
...
User Request
  ...
  Agent (LLM + Reasoning)
      ⬇️
 Function Calling (recherche web avec searXNG)
      ⬇️
  Aggregation & Planningu
      ⬇️
    Travel Itinerary
```
